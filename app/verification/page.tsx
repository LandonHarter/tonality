...
export default function VerificationPage() {
    ...
    return (
        <main className={styles.container}>
            <svg height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" className={styles.check_mark}
		...
		S509.502,87.794,504.969,83.262z"/>
            ...
            <p>If you are having trouble, it may be in your junk mail</p>
        </main>
    );
}